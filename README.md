...
Since Pocket Paint is now available in **Google Play store** you can also download Paintroid (Pocket Paint) from [here](https://play.google.com/store/apps/details?id=com.widgetly.iartbook). Alternatively, you can find it on **F-Droid** [here](https://f-droid.org/packages/com.widgetly.iartbook/).
...
# Resources and links #
* [Google Play Store Download](https://play.google.com/store/apps/details?id=com.widgetly.iartbook)
* [F-Droid Download](https://f-droid.org/packages/com.widgetly.iartbook/)

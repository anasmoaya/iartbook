...
import com.widgetly.iartbook.test.espresso.util.wrappers.TransformToolOptionsViewInteraction.onTransformToolOptionsView
...
class TransformToolIntegrationTest {
    ...
    private lateinit var activityHelper: com.widgetly.iartbook.test.espresso.util.MainActivityHelper
    ...
    fun setUp() {
        ...
        activityHelper = com.widgetly.iartbook.test.espresso.util.MainActivityHelper(mainActivity)
    ...
    fun testWhenNoPixelIsOnBitmap() {
        ...
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.TOOL_POSITION))
        onDrawingSurfaceView()
            .checkBitmapDimension(initialWidth, initialHeight)
            .checkLayerDimensions(initialWidth, initialHeight)
    }
    ...
    fun testIfOnePixelIsFound() {
        ...
        com.widgetly.iartbook.test.espresso.util.wrappers.TopBarViewInteraction.onTopBarView().performClickCheckmark()
        onDrawingSurfaceView()
    ...
    fun testMaxImageResolution() {
        ...
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.swipe(dragFrom, dragTo))
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.TOOL_POSITION))
    ...
    fun testRotateLeft() {
        ...
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_BOTTOM_LEFT))
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolPropertiesInteraction.onToolProperties()
        ...
        onToolBarView()
            .performSelectTool(ToolType.PIPETTE)
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_TOP_RIGHT))
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolPropertiesInteraction.onToolProperties()
            .checkMatchesColorResource(R.color.pocketpaint_color_picker_green1)
        onToolBarView()
            .performSelectTool(ToolType.TRANSFORM)
    ...
    fun testRotateMultipleLayersUndoRedoWhenRotatingWasNotLastCommand() {
        ...
        com.widgetly.iartbook.test.espresso.util.wrappers.TopBarViewInteraction.onTopBarView().onUndoButton()
            .check(ViewAssertions.matches(isEnabled()))
        com.widgetly.iartbook.test.espresso.util.wrappers.TopBarViewInteraction.onTopBarView().onRedoButton()
    ...
    fun testTransformToolSetCenterCloseCenter() {
        ...
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.BOTTOM_RIGHT_CLOSE_CENTER))
        runBlocking {
            com.widgetly.iartbook.test.espresso.util.wrappers.TopBarViewInteraction.onTopBarView().performClickCheckmark()
            delay(1500)
        }
    ...
    fun testTransformToolSetCenterFarCenter() {
        ...
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.BOTTOM_RIGHT_CORNER))
        runBlocking {
            com.widgetly.iartbook.test.espresso.util.wrappers.TopBarViewInteraction.onTopBarView().performClickCheckmark()
            delay(1500)
        }

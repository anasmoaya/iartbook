...
class MoreOptionsIntegrationTest {
    ...
    fun testMoreOptionsAllItemsExist() {
        com.widgetly.iartbook.test.espresso.util.wrappers.OptionsMenuViewInteraction.onOptionsMenu()
    ...
    fun testShowLikeUsDialogOnFirstSave() {
        ...
        Espresso.onView(ViewMatchers.isRoot()).perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.waitFor(100))

...
class LineToolIntegrationTest {
    ...
    fun testCheckmarkLineFeature() {
        ...
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_RIGHT_MIDDLE))
        onDrawingSurfaceView()
            .checkPixelColor(Color.BLACK, com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_RIGHT_MIDDLE)
        onTopBarView().onCheckmarkButton()
            .check(
                ViewAssertions.matches(
                    Matchers.allOf(
                        com.widgetly.iartbook.test.espresso.util.UiMatcher.withDrawable(R.drawable.ic_pocketpaint_checkmark),
    ...
    fun testCheckmarkLineFeatureChangeColor() {
        ...
        onDrawingSurfaceView()
            .checkPixelColor(Color.GREEN, com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_LEFT_MIDDLE)
        onDrawingSurfaceView()
            .checkPixelColor(Color.TRANSPARENT, com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_RIGHT_MIDDLE)
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_RIGHT_MIDDLE))
        onDrawingSurfaceView()
            .checkPixelColor(Color.GREEN, com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_RIGHT_MIDDLE)
        onTopBarView().onCheckmarkButton()
            .check(
                ViewAssertions.matches(
                    Matchers.allOf(
    ...
    fun testConnectedLinesFeature() {
        ...
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_BOTTOM_MIDDLE))
        onDrawingSurfaceView()
            .checkPixelColor(Color.BLACK, com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_BOTTOM_MIDDLE)
        onTopBarView().performClickPlus()
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_TOP_LEFT))
        onDrawingSurfaceView().checkPixelColor(Color.BLACK, com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_TOP_LEFT)
        onTopBarView().performClickCheckmark()
    }
    ...
    fun testUndoWithDrawingConnectedLines() {
        ...
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_BOTTOM_RIGHT))
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_TOP_MIDDLE))
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_TOP_LEFT))
        onDrawingSurfaceView()
            .perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchAt(com.widgetly.iartbook.test.espresso.util.DrawingSurfaceLocationProvider.HALFWAY_BOTTOM_RIGHT))
        ...
        onDrawingSurfaceView()
            .checkPixelColor(Color.TRANSPARENT, com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_BOTTOM_RIGHT)
        onDrawingSurfaceView()
            .checkPixelColor(Color.BLACK, com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_BOTTOM_LEFT)
        onTopBarView().performClickCheckmark()
    }
    ...
    fun testColorChangesInConnectedLineMode() {
        ...
        onDrawingSurfaceView()
            .checkPixelColor(
                ...
                com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_BOTTOM_RIGHT
            )
    ...
    fun testColorChangesAndQuittingConnectedLineMode() {
        ...
        onDrawingSurfaceView()
            .checkPixelColor(
                Color.parseColor("#FF0074CD"),
                com.widgetly.iartbook.test.espresso.util.BitmapLocationProvider.HALFWAY_BOTTOM_LEFT
            )
        onDrawingSurfaceView()

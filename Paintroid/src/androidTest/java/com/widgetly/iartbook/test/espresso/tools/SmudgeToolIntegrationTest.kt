...
import com.widgetly.iartbook.test.espresso.util.UiMatcher.withProgress
...
class SmudgeToolIntegrationTest {
    ...
    fun setUp() {
        ...
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolBarViewInteraction.onToolBarView().performSelectTool(ToolType.SMUDGE)
    }

 ...
 */
package com.widgetly.iartbook.test.espresso.screenshots
...
class CreateMarketingScreenshots {
    ...
    fun createScreenshots() {
        ...
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolBarViewInteraction.onToolBarView().performSelectTool(ToolType.FILL)
    ...
    private fun screenshotTools() {
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolBarViewInteraction.onToolBarView().onToolsClicked()
    ...
    private fun screenshotHeart() {
        ...
        com.widgetly.iartbook.test.espresso.util.wrappers.BottomNavigationViewInteraction.onBottomNavigationView()
            .onCurrentClicked()
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolPropertiesInteraction.onToolProperties()
            .setColorResource(R.color.pocketpaint_color_picker_red1)
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolBarViewInteraction.onToolBarView().performSelectTool(ToolType.SHAPE)
        com.widgetly.iartbook.test.espresso.util.wrappers.ShapeToolOptionsViewInteraction.onShapeToolOptionsView()
    ...
    private fun screenshotColorPicker() {
        ...
        com.widgetly.iartbook.test.espresso.util.wrappers.ColorPickerViewInteraction.onColorPickerView()
            .performOpenColorPicker()
        onView(
            allOf(
                withId(R.id.color_picker_tab_icon),
                com.widgetly.iartbook.test.espresso.util.UiMatcher.withBackground(R.drawable.ic_color_picker_tab_rgba)
            )
        ).perform(click())
        onView(withId(R.id.color_picker_color_rgb_seekbar_blue)).perform(com.widgetly.iartbook.test.espresso.util.UiInteractions.touchCenterRight())
        closeSoftKeyboard()

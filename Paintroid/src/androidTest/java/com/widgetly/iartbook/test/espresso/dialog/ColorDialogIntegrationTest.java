...
package com.widgetly.iartbook.test.espresso.dialog;
...
import com.widgetly.iartbook.test.espresso.util.UiInteractions;
import com.widgetly.iartbook.test.espresso.util.wrappers.ColorPickerViewInteraction;
...
import static com.widgetly.iartbook.test.espresso.util.UiInteractions.touchCenterLeft;
import static com.widgetly.iartbook.test.espresso.util.UiInteractions.touchCenterMiddle;
import static com.widgetly.iartbook.test.espresso.util.UiInteractions.touchCenterRight;
import static com.widgetly.iartbook.test.espresso.util.UiMatcher.withBackground;
import static com.widgetly.iartbook.test.espresso.util.UiMatcher.withBackgroundColor;
import static com.widgetly.iartbook.test.espresso.util.UiMatcher.withTextColor;
import static com.widgetly.iartbook.test.espresso.util.wrappers.ColorPickerViewInteraction.MAXIMUM_COLORS_IN_HISTORY;
import static com.widgetly.iartbook.test.espresso.util.wrappers.ColorPickerViewInteraction.onColorPickerView;
import static com.widgetly.iartbook.test.espresso.util.wrappers.DrawingSurfaceInteraction.onDrawingSurfaceView;
import static com.widgetly.iartbook.test.espresso.util.wrappers.ToolPropertiesInteraction.onToolProperties;
import static com.widgetly.iartbook.test.espresso.util.wrappers.TopBarViewInteraction.onTopBarView;

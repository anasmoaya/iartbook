...
import static com.widgetly.iartbook.test.espresso.util.PositionCoordinatesProvider.calculateViewOffset;
...
public enum DrawingSurfaceLocationProvider implements CoordinatesProvider {
	...
	TOOL_POSITION {
		@Override
		public float[] calculateCoordinates(View view) {
			MainActivity mainActivity = MainActivityHelper.getMainActivityFromView(view);

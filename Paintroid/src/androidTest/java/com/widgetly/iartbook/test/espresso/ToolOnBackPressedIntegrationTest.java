...
import com.widgetly.iartbook.test.espresso.util.wrappers.TopBarViewInteraction;
...
import com.widgetly.iartbook.test.espresso.util.EspressoUtils;
...
import com.widgetly.iartbook.test.espresso.util.wrappers.ConfirmQuitDialogInteraction;
import com.widgetly.iartbook.test.espresso.util.wrappers.DrawingSurfaceInteraction;
import com.widgetly.iartbook.test.espresso.util.wrappers.ToolBarViewInteraction;
...
public class ToolOnBackPressedIntegrationTest {
	...
	public void testBrushToolBackPressedWithSaveAndOverride() throws IOException, InterruptedException {
		...
		onView(isRoot()).perform(UiInteractions.waitFor(3000));
		...
		onView(isRoot()).perform(UiInteractions.waitFor(2000));

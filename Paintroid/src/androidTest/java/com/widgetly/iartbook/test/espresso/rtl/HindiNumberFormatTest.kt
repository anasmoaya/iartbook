...
package com.widgetly.iartbook.test.espresso.rtl
...
class HindiNumberFormatTest {
    ...
    var launchActivityRule: ActivityTestRule<MainActivity> =
        com.widgetly.iartbook.test.espresso.rtl.util.RtlActivityTestRule(
    ...
    fun testHindiNumberAtTool() {
        ...
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolBarViewInteraction.onToolBarView().performSelectTool(ToolType.LINE)
        Espresso.onView(ViewMatchers.withId(R.id.pocketpaint_stroke_width_width_text))
            .check(ViewAssertions.matches(ViewMatchers.withText(
                Matchers.containsString(EXPECTED_STROKE_WIDTH_VALUE))))
        com.widgetly.iartbook.test.espresso.util.wrappers.ToolBarViewInteraction.onToolBarView().performSelectTool(ToolType.CURSOR)
        Espresso.onView(ViewMatchers.withId(R.id.pocketpaint_stroke_width_width_text))
            .check(ViewAssertions.matches(ViewMatchers.withText(
                        Matchers.containsString(EXPECTED_STROKE_WIDTH_VALUE))))

...
import com.widgetly.iartbookid.command.CommandManager.CommandListener
import com.widgetly.iartbookid.command.implementation.AsyncCommandManager
import com.widgetly.iartbookid.command.implementation.DefaultCommandFactory
import com.widgetly.iartbookid.command.implementation.DefaultCommandManager
...
import com.widgetly.iartbookid.common.CommonFactory
import com.widgetly.iartbookid.common.PAINTROID_PICTURE_NAME
...
import com.widgetly.iartbookid.contract.MainActivityContracts.MainView
import com.widgetly.iartbookid.controller.DefaultToolController
import com.widgetly.iartbookid.listener.DrawerLayoutListener
import com.widgetly.iartbookid.listener.PresenterColorPickedListener
import com.widgetly.iartbookid.model.LayerModel
import com.widgetly.iartbookid.model.MainActivityModel
import com.widgetly.iartbookid.presenter.LayerPresenter
...
import com.widgetly.iartbookid.tools.implementation.BaseToolWithShape
import com.widgetly.iartbookid.tools.implementation.ClippingTool
import com.widgetly.iartbookid.tools.implementation.DefaultContextCallback
import com.widgetly.iartbookid.tools.implementation.DefaultToolFactory
import com.widgetly.iartbookid.tools.implementation.DefaultToolPaint
import com.widgetly.iartbookid.tools.implementation.DefaultToolReference
import com.widgetly.iartbookid.tools.implementation.DefaultWorkspace
import com.widgetly.iartbookid.tools.implementation.LineTool
import com.widgetly.iartbookid.tools.implementation.TransformTool
import com.widgetly.iartbookid.tools.options.ToolOptionsViewController
import com.widgetly.iartbookid.ui.DrawingSurface
import com.widgetly.iartbookid.ui.KeyboardListener
import com.widgetly.iartbookid.ui.LayerAdapter
import com.widgetly.iartbookid.ui.LayerNavigator
import com.widgetly.iartbookid.ui.MainActivityInteractor
import com.widgetly.iartbookid.ui.MainActivityNavigator
import com.widgetly.iartbookid.ui.Perspective
import com.widgetly.iartbookid.ui.dragndrop.DragAndDropListView
import com.widgetly.iartbookid.ui.tools.DefaultToolOptionsViewController
import com.widgetly.iartbookid.ui.viewholder.BottomBarViewHolder
import com.widgetly.iartbookid.ui.viewholder.BottomNavigationViewHolder
import com.widgetly.iartbookid.ui.viewholder.DrawerLayoutViewHolder
import com.widgetly.iartbookid.ui.viewholder.LayerMenuViewHolder
import com.widgetly.iartbookid.ui.viewholder.TopBarViewHolder
import com.widgetly.iartbookid.ui.zoomwindow.DefaultZoomWindowController
import java.io.File
...
class MainActivity : AppCompatActivity(), MainView, CommandListener {
        ...
        try {
            if (mimeType.equals("application/zip") || mimeType.equals("application/octet-stream")) {
                try {
                    ...
                    _root_ide_package_.com.widgetly.iartbook.iotasks.OpenRasterFileFormatConversion.mainActivity = this
                    _root_ide_package_.com.widgetly.iartbook.iotasks.OpenRasterFileFormatConversion.importOraFile(
                        myContentResolver,
                        receivedUri
                ...
                _root_ide_package_.com.widgetly.iartbook.FileIO.filename = "image"
                _root_ide_package_.com.widgetly.iartbook.FileIO.getBitmapFromUri(myContentResolver, receivedUri, applicationContext)
                    ?.let { receivedBitmap ->
                        commandManager.setInitialStateCommand(
                            commandFactory.createInitCommand(
                                receivedBitmap
    ...
    private fun onCreateMainView() {
        ...
        _root_ide_package_.com.widgetly.iartbook.FileIO.navigator = navigator

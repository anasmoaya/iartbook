...
class SaveImage(
    ...
    private fun saveOraFile(
        ...
        _root_ide_package_.com.widgetly.iartbook.iotasks.OpenRasterFileFormatConversion.saveOraFileToUri(
            layers,
            uri,
            fileName,
            bitmap,
    ...
    private fun exportOraFile(
        ...
        _root_ide_package_.com.widgetly.iartbook.iotasks.OpenRasterFileFormatConversion.exportToOraFile(
            layers,
            fileName,
            bitmap,
            contentResolver

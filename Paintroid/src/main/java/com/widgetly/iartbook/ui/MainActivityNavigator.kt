...
import com.widgetly.iartbookid.FileIO
import com.widgetly.iartbookid.MainActivity
import com.widgetly.iartbookid.R
import com.widgetly.iartbookid.UserPreferences
import com.widgetly.iartbookid.WelcomeActivity
import com.widgetly.iartbookid.colorpicker.ColorPickerDialog
import com.widgetly.iartbookid.colorpicker.OnColorPickedListener
import com.widgetly.iartbookid.command.CommandFactory
import com.widgetly.iartbookid.command.implementation.DefaultCommandFactory
import com.widgetly.iartbookid.common.ABOUT_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.common.ADVANCED_SETTINGS_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.common.CATROBAT_INFORMATION_DIALOG_TAG
import com.widgetly.iartbookid.common.CATROID_MEDIA_GALLERY_FRAGMENT_TAG
import com.widgetly.iartbookid.common.COLOR_PICKER_DIALOG_TAG
import com.widgetly.iartbookid.common.FEEDBACK_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.common.INDETERMINATE_PROGRESS_DIALOG_TAG
import com.widgetly.iartbookid.common.JPG_INFORMATION_DIALOG_TAG
import com.widgetly.iartbookid.common.LIKE_US_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.common.LOAD_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.common.MainActivityConstants.ActivityRequestCode
import com.widgetly.iartbookid.common.ORA_INFORMATION_DIALOG_TAG
import com.widgetly.iartbookid.common.OVERWRITE_INFORMATION_DIALOG_TAG
import com.widgetly.iartbookid.common.PAINTROID_PICTURE_PATH
import com.widgetly.iartbookid.common.PERMISSION_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.common.PERMISSION_EXTERNAL_STORAGE_SAVE_COPY
import com.widgetly.iartbookid.common.PNG_INFORMATION_DIALOG_TAG
import com.widgetly.iartbookid.common.RATE_US_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.common.SAVE_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.common.SAVE_INFORMATION_DIALOG_TAG
import com.widgetly.iartbookid.common.SAVE_QUESTION_FRAGMENT_TAG
import com.widgetly.iartbookid.common.SCALE_IMAGE_FRAGMENT_TAG
import com.widgetly.iartbookid.common.ZOOM_WINDOW_SETTINGS_DIALOG_FRAGMENT_TAG
import com.widgetly.iartbookid.contract.MainActivityContracts
import com.widgetly.iartbookid.dialog.AboutDialog
import com.widgetly.iartbookid.dialog.AdvancedSettingsDialog
import com.widgetly.iartbookid.dialog.CatrobatImageInfoDialog
import com.widgetly.iartbookid.dialog.FeedbackDialog
import com.widgetly.iartbookid.dialog.ImportImageDialog
import com.widgetly.iartbookid.dialog.IndeterminateProgressDialog
import com.widgetly.iartbookid.dialog.InfoDialog
import com.widgetly.iartbookid.dialog.JpgInfoDialog
import com.widgetly.iartbookid.dialog.LikeUsDialog
import com.widgetly.iartbookid.dialog.OraInfoDialog
import com.widgetly.iartbookid.dialog.OverwriteDialog
import com.widgetly.iartbookid.dialog.PermanentDenialPermissionInfoDialog
import com.widgetly.iartbookid.dialog.PermissionInfoDialog
import com.widgetly.iartbookid.dialog.PermissionInfoDialog.PermissionType
import com.widgetly.iartbookid.dialog.PngInfoDialog
import com.widgetly.iartbookid.dialog.RateUsDialog
import com.widgetly.iartbookid.dialog.SaveBeforeFinishDialog
import com.widgetly.iartbookid.dialog.SaveBeforeLoadImageDialog
import com.widgetly.iartbookid.dialog.SaveBeforeNewImageDialog
import com.widgetly.iartbookid.dialog.SaveInformationDialog
import com.widgetly.iartbookid.dialog.ScaleImageOnLoadDialog
import com.widgetly.iartbookid.dialog.ZoomWindowSettingsDialog
import com.widgetly.iartbookid.tools.ToolReference
import com.widgetly.iartbookid.tools.ToolType
import com.widgetly.iartbookid.ui.fragments.CatroidMediaGalleryFragment
import com.widgetly.iartbookid.ui.fragments.CatroidMediaGalleryFragment.MediaGalleryListener
